 ...
 */
package com.activeviam.pypivot.cfg.security;
...
import com.activeviam.pypivot.cfg.ActiveUIResourceServerConfig;
...
public class SecurityConfig {
	...
	public UserDetailsService userDetailsService() throws Exception {
		...
		InMemoryUserDetailsManagerConfigurer<AuthenticationManagerBuilder> inMemUserDetailsManagerConfig = 
				...
				.withUser(USER_ADMIN).password(PASSWORD_ADMIN).authorities(ROLE_ADMIN,ROLE_CS_ROOT)
				.and()
				;
	...
	@Bean
	public JwtFilter jwtFilter(final AuthenticationManager authenticationManagerBean) {
		return new JwtFilter(
				authenticationManagerBean,
				JwtService.PRINCIPAL_CLAIM_KEY,
				JwtService.AUTHORITIES_CLAIM_KEY);
	}
